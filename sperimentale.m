...
for k=1:(n-1)
    ...
    quat(:,k+1) = quat(:,k+1)./norm_quat; % normalized quaternion
    eul(1,k+1) = atan(2*(quat(2,k+1)*quat(3,k+1)+quat(1,k+1)*quat(4,k+1))/(quat(1,k+1)^2+quat(2,k+1)^2-quat(3,k+1)^2-quat(4,k+1)^2)); % yaw (psi)
    psi_arg = 2*(quat(2,k+1)*quat(3,k+1)+quat(1,k+1)*quat(4,k+1))/(quat(1,k+1)^2+quat(2,k+1)^2-quat(3,k+1)^2-quat(4,k+1)^2)
    eul(2,k+1) = asin(-2*(quat(2,k+1)*quat(4,k+1)-quat(1,k+1)*quat(3,k+1))); % pitch (theta)
    theta_arg = -2*(quat(2,k+1)*quat(4,k+1)-quat(1,k+1)*quat(3,k+1))
    eul(3,k+1) = atan(2*(quat(3,k+1)*quat(4,k+1)+quat(1,k+1)*quat(2,k+1))/(quat(1,k+1)^2-quat(2,k+1)^2-quat(3,k+1)^2+quat(4,k+1)^2)); % roll (phi)
    fi_arg = 2*(quat(3,k+1)*quat(4,k+1)+quat(1,k+1)*quat(2,k+1))/(quat(1,k+1)^2-quat(2,k+1)^2-quat(3,k+1)^2+quat(4,k+1)^2)
