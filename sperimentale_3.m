...
for k=1:(n-1)
    ...
    accel_tot(1,k) = accel(1,k)+gyro(2,k)*vel(3,k)-gyro(3,k)*vel(2,k)-9.8*cos(eul(3,k))*sin(eul(2,k));
    accel_tot(2,k) = accel(2,k)+gyro(3,k)*vel(1,k)-gyro(1,k)*vel(3,k)-9.8*sin(eul(3,k));
